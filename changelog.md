...
- Updated build prop to the latest crDroid beta build 11.2 04/03/2025.
...
## Version v4.2 (komodo)
- Updated build prop to the latest crDroid build 11.2 03/12/2025.
...
- Updated installer to show detailed info on what apps are being installed for better transparency.
